          ...
          <form id="editCarForm" onSubmit={handleSubmit} className="space-y-10">
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input required name="year" value={formData.year} onChange={handleChange} className="w-full bg-bg-main border border-border-color rounded-xl px-4 py-2.5 text-main focus:ring-2 focus:ring-accent outline-none font-medium" />
                </div>
                <div className="space-y-2">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                <div className="space-y-2">
                  ...
                  <input required type="text" name="purchase_price" value={formData.purchase_price} onChange={handleCurrencyChange} className="w-full bg-bg-main border border-border-color rounded-xl px-4 py-2.5 text-main focus:ring-2 focus:ring-accent outline-none font-medium" />
                </div>
                <div className="space-y-2">
                ...
                {(formData.payment_method === 'Financiado' || formData.payment_method === 'Consórcio') && (
                  <>
                    <div className="space-y-2">
                      ...
                      <input type="text" name="financed_down_payment" value={formData.financed_down_payment} onChange={handleCurrencyChange} className="w-full bg-bg-main border border-border-color rounded-xl px-4 py-2.5 text-main focus:ring-2 focus:ring-accent outline-none font-medium" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase tracking-widest text-muted-olive">Parcelas</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-black uppercase tracking-widest text-muted-olive">Valor Parcela (R$)</label>
                      <input type="text" name="financed_installment_value" value={formData.financed_installment_value} onChange={handleCurrencyChange} className="w-full bg-bg-main border border-border-color rounded-xl px-4 py-2.5 text-main focus:ring-2 focus:ring-accent outline-none font-medium" />
                    </div>
                  </>
                )}
              </div>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-black uppercase tracking-widest text-muted-olive">Status Geral</label>
            ...
            <section>
              ...
              <textarea name="notes" value={formData.notes} onChange={handleChange} rows="3" className="w-full bg-bg-main border border-border-color rounded-xl px-4 py-3 text-main focus:ring-2 focus:ring-accent outline-none resize-none font-medium"></textarea>
            </section>

          </form>
        </div>

        <div className="p-6 border-t border-border-color bg-slate-50/50 dark:bg-slate-950/20 flex justify-end gap-3 shadow-[0_-10px_20px_rgba(0,0,0,0.03)]">
          <button type="button" onClick={onClose} className="px-5 py-2.5 rounded-xl text-muted-olive hover:text-main font-bold text-sm">
            Cancelar
          </button>
